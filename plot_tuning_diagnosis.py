...
george/real_data_diagnosis.png, referenced in docs/handover_explained.md and
docs/followup_questions.md) for an arbitrary scan.

Uses the exact pipeline functions from process_reflectogram.py (load,
balanced subtraction, nominal-grid resample, phase_correct) -- nothing
reimplemented, just assembled into the same layout:
...
Usage: python plot_tuning_diagnosis.py scan.json [--out prefix]
"""
